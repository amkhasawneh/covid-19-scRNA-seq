...
names(fgsea_sets) <-
  gsub(pattern = "HALLMARK_",
       replacement = "",
       x = names(fgsea_sets)) |> gsub(pattern = "_", replacement = " ")
...
topPathways <-
  bind_rows(topUpmod, topDownmod, topUpcrit, topDowncrit) #%>% arrange(-rank)
...
top <-
  topPathways %>% group_by(cluster) %>% subset(p_val_adj < 0.05)
...
ggsave(
  filename = "graphs/seurat-rrho-pt1.jpeg",
  dpi = "print",
  width = 15,
  height = 10,
  plot = DoHeatmap(
...
ggsave(
  filename = "graphs/enrichment-pt1-seurat-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-pt1-seurat-crit.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
write.table(mrk.pt2,
            file = "top-seurat-markers-pt2.tsv",
            sep = "\t",
            col.names = NA)
...
ggsave(
  filename = "graphs/seurat-rrho-pt2.jpeg",
  dpi = "print",
  width = 15,
  height = 10,
  plot = DoHeatmap(
...
ggsave(
  filename = "graphs/enrichment-pt2-seurat-crit.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-pt2-seurat-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
write.table(mrk.pt3,
            file = "top-seurat-markers-v-3-48-pt3.tsv",
            sep = "\t",
            col.names = NA)
...
ggsave(
  filename = "graphs/seurat-rrho-v-3-48-pt3.jpeg",
  dpi = "print",
  width = 15,
  height = 10,
  plot = DoHeatmap(
...
ggsave(
  filename = "graphs/enrichment-pt3-seurat-crit-v-3-48.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-pt3-seurat-mod-v-3-48.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
write.table(mrk.pt4,
            file = "top-wilcox-markers-v-3-23-pt4.tsv",
            sep = "\t",
            col.names = NA)
...
ggsave(
  filename = "graphs/seurat-rrho-v-3-23-pt4.jpeg",
  dpi = "print",
  width = 15,
  height = 10,
  plot = DoHeatmap(
...
ggsave(
  filename = "graphs/enrichment-pt4-seurat-v-3-23-crit.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-pt4-seurat-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
write.table(mrk.pt5,
            file = "top-seurat-markers-pt5.tsv",
            sep = "\t",
            col.names = NA)
...
ggsave(
  filename = "graphs/seurat-rrho-pt5.jpeg",
  dpi = "print",
  width = 15,
  height = 10,
  plot = DoHeatmap(
...
ggsave(
  filename = "graphs/enrichment-pt5-seurat-crit.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-pt5-seurat-sev.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-pt5-seurat-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
write.table(
  ...
  file = "top-seurat-markers-pt6.tsv",
  sep = "\t",
  col.names = NA
)
...
ggsave(
  filename = "graphs/seurat-rrho-pt6.jpeg",
  dpi = "print",
  width = 15,
  height = 10,
  plot = DoHeatmap(
...
ggsave(
  filename = "graphs/enrichment-pt6-seurat-crit.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-pt6-seurat-sev.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-pt6-seurat-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
write.table(
  top_markers(wlx.mrk),
  file = "top-wilcox-markers-pt1-vs-all.tsv",
  sep = "\t",
  col.names = NA
)
...
topPathways <-
  bind_rows(topUppt1, topDownpt1, topUpother, topDownother) #%>% arrange(-rank)
...
ggsave(
  filename = "graphs/wilcox-rrho-pt1-vs-all.jpeg",
  dpi = "print",
  width = 15,
  height = 10,
  plot = DoHeatmap(
...
ggsave(
  filename = "graphs/enrichment-pt1-vs-all-wlx.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-all-vs-pt1-wlx.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
wlx.mrk.pt1 <-
  wilcoxauc(
    pt1,
    'sample',
    c("moderate272_Patient1", "critical293_Patient1"),
    seurat_assay = 'RNA',
    assay = "data"
  ) %>%
  subset(p_val_adj < 0.05) %>% arrange(p_val_adj)
...
write.table(
  top_markers(wlx.mrk.pt1),
  file = "top-wilcox-markers-v-1-18-pt1.tsv",
  sep = "\t",
  col.names = NA
)
...
ggsave(
  filename = "graphs/wilcox-rrho-v-1-18-pt1.jpeg",
  dpi = "print",
  width = 15,
  height = 10,
  plot = DoHeatmap(
...
ggsave(
  filename = "graphs/enrichment-v-1-18-pt1-wlx-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-v-1-18-pt1-wlx-crit.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
...
#Cleaning gene set:
ISGs <-
  ISGs[!grepl(ISGs, pattern = "LOC") &
         !grepl(ISGs, pattern = "XENTR") & !grepl(ISGs, pattern = "GSON")]
ISGs <- ISGs[ISGs != ""]
...
write.table(
  top_markers(wlx.mrk.pt1),
  file = "top-wilcox-markers-pt1.tsv",
  sep = "\t",
  col.names = NA
)
...
alldata$severity <-
  factor(alldata$severity, levels = c("moderate", "critical"))

ggsave(
  filename = "graphs/wilcox-rrho-pt1.jpeg",
  dpi = "print",
  width = 7.5,
  height = 5,
  plot = DoHeatmap(
    alldata,
    features = unique(top$feature),
    group.by = "severity",
    size = 2,
    raster = TRUE,
    label = FALSE
...
enrich.topUpmod1[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpmod1[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpmod1[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpmod1[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
...
#Enrichment plots:
ggsave(
  filename = "graphs/enrichment-plot-pt1-critical-moderate.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt1-moderate-critical.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
#Plotting pathways:
fgseaRes_c1$adjPvalue <-
  ifelse(fgseaRes_c1$padj <= 0.05, "significant", "non-significant")
cols <- c("significant" = "red") #"non-significant" = "grey",
plot_c1 <-
  ggplot(fgseaRes_c1, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
...
ggsave(
  filename = "graphs/gsea-pt1-critical-vs-moderate-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
write.table(
  top_markers(wlx.mrk.pt2),
  file = "top-wilcox-markers-pt2.tsv",
  sep = "\t",
  col.names = NA
)
...
ggsave(
  filename = "graphs/wilcox-rrho-pt2.jpeg",
  dpi = "print",
  width = 7.5,
  height = 5,
  plot = DoHeatmap(
...
enrich.topUpmod2[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpmod2[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpcrit2[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpcrit2[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
...
#Enrichment plots:
ggsave(
  filename = "graphs/enrichment-plot-pt2-critical-moderate.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt2-moderate-critical.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
#Plotting pathways:
fgseaRes_c2$adjPvalue <-
  ifelse(fgseaRes_c2$padj <= 0.05, "significant", "non-significant")
cols <- c("significant" = "red") #"non-significant" = "grey",
plot_c2 <-
  ggplot(fgseaRes_c2, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt2-critical-vs-moderate-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
write.table(
  top_markers(wlx.mrk.pt3),
  file = "top-wilcox-markers-pt3.tsv",
  sep = "\t",
  col.names = NA
)
...
alldata$severity <-
  factor(alldata$severity, levels = c("mild", "critical"))


ggsave(
  filename = "graphs/wilcox-rrho-pt3.jpeg",
  dpi = "print",
  width = 7.5,
  height = 5,
  plot = DoHeatmap(
...
enrich.topUpmod3[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpmod3[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpcrit3[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpcrit3[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
...
#Enrichment plots:
ggsave(
  filename = "graphs/enrichment-plot-pt3-critical-mild.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt3-mild-critical.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
#Plotting pathways:
fgseaRes_c3$adjPvalue <-
  ifelse(fgseaRes_c3$padj <= 0.05, "significant", "non-significant")
cols <- c("significant" = "red") #"non-significant" = "grey",
plot_c3 <-
  ggplot(fgseaRes_c3, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt3-critical-vs-mild-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
write.table(
  top_markers(wlx.mrk.pt4),
  file = "top-wilcox-markers-pt4.tsv",
  sep = "\t",
  col.names = NA
)
...
ggsave(
  filename = "graphs/wilcox-rrho-pt4.jpeg",
  dpi = "print",
  width = 7.5,
  height = 5,
  plot = DoHeatmap(
...
enrich.topUpmod4[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpmod4[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpcrit4[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpcrit4[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
...
#Enrichment plots:
ggsave(
  filename = "graphs/enrichment-plot-pt4-critical-mild.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt5-mild-critical.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
#Plotting pathways:
fgseaRes_c4$adjPvalue <-
  ifelse(fgseaRes_c4$padj <= 0.05, "significant", "non-significant")
cols <- c("significant" = "red") #"non-significant" = "grey",
plot_c4 <-
  ggplot(fgseaRes_c4, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt4-critical-vs-mild-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
write.table(
  top_markers(wlx.mrk.pt5.cm),
  file = "top-wilcox-markers-pt5-cm.tsv",
  sep = "\t",
  col.names = NA
)
...
# create a scale.data slot for the selected genes in subset data
alldata <-
  ScaleData(object = pt5[, pt5$severity != "severe"] %>% droplevels(),
            features = as.character(unique(top$feature), assay = "RNA"))
...
ggsave(
  filename = "graphs/wilcox-rrho-pt5.jpeg",
  dpi = "print",
  width = 7.5,
  height = 5,
  plot = DoHeatmap(
...
enrich.topUpmod5.mc[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpmod5.mc[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpmod5.ms[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpmod5.ms[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpsev5.cs[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpsev5.cs[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpsev5.ms[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpsev5.ms[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpcrit5.cs[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpcrit5.cs[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpcrit5.cm[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpcrit5.cm[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)


ggsave(
  filename = "graphs/enrichment-pt5-wlx-crit-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpcrit5.cm[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
ggsave(
  filename = "graphs/enrichment-pt5-wlx-crit-sev.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpcrit5.cs[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
ggsave(
  filename = "graphs/enrichment-pt5-wlx-sev-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpsev5.ms[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
ggsave(
  filename = "graphs/enrichment-pt5-wlx-sev-crit.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpsev5.cs[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
ggsave(
  filename = "graphs/enrichment-pt5-wlx-mod-sev.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpmod5.ms[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
ggsave(
  filename = "graphs/enrichment-pt5-wlx-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpmod5.mc[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
#Enrichment plots:
ggsave(
  filename = "graphs/enrichment-plot-pt5-critical-severe.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt5-critical-moderate.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt5-severe-critical.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt5-severe-moderate.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt5-moderate-critical.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt5-moderate-severe.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
#Plotting pathways:
fgseaRes_cs5$adjPvalue <-
  ifelse(fgseaRes_cs5$padj <= 0.05, "significant", "non-significant")
cols <- c("significant" = "red") #"non-significant" = "grey",
plot_cs <-
  ggplot(fgseaRes_cs5, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt5-critical-vs-severe-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
fgseaRes_cm5$adjPvalue <-
  ifelse(fgseaRes_cm5$padj <= 0.05, "significant", "non-significant")
cols <- c("significant" = "red") #"non-significant" = "grey",
plot_cm <-
  ggplot(fgseaRes_cm5, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt5-critical-vs-moderate-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
fgseaRes_sc5$adjPvalue <-
  ifelse(fgseaRes_sc5$padj <= 0.05, "significant", "non-significant")
plot_sc <-
  ggplot(fgseaRes_sc5, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt5-severe-vs-critical-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
fgseaRes_sm5$adjPvalue <-
  ifelse(fgseaRes_sm5$padj <= 0.05, "significant", "non-significant")
plot_sm <-
  ggplot(fgseaRes_sm5, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt5-severe-vs-moderate-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
fgseaRes_mc5$adjPvalue <-
  ifelse(fgseaRes_mc5$padj <= 0.05, "significant", "non-significant")
plot_mc <-
  ggplot(fgseaRes_mc5, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt5-moderatee-vs-critical-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
fgseaRes_ms5$adjPvalue <-
  ifelse(fgseaRes_ms5$padj <= 0.05, "significant", "non-significant")
plot_ms <-
  ggplot(fgseaRes_ms, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt5-moderatee-vs-severe-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
write.table(
  top_markers(wlx.mrk.pt6),
  file = "top-wilcox-markers-pt6.tsv",
  sep = "\t",
  col.names = NA
)
...
# create a scale.data slot for the selected genes in subset data
alldata <-
  ScaleData(object = pt6[, pt6$severity != "severe"] %>% droplevels(),
            features = as.character(unique(top$feature), assay = "RNA"))

DefaultAssay(alldata) <- "RNA"

ggsave(
  filename = "graphs/wilcox-rrho-pt6.jpeg",
  dpi = "print",
  width = 7.5,
  height = 5,
  plot = DoHeatmap(
...
enrich.topUpmod6.cm[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpmod6.cm[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpmod6.sm[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpmod6.sm[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpsev6.cs[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpsev6.cs[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpsev6.sm[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpsev6.sm[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpcrit6.cs[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpcrit6.cs[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)
enrich.topUpcrit6.cm[["GO_Biological_Process_2021"]]$Term <-
  vapply(str_split(enrich.topUpcrit6.cm[["GO_Biological_Process_2021"]]$Term, "[(GO:*)]"), "[", "", 1)


ggsave(
  filename = "graphs/enrichment-pt6-wlx-crit-sev.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpcrit6.cs[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
ggsave(
  filename = "graphs/enrichment-pt6-wlx-crit-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpcrit6.cm[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
ggsave(
  filename = "graphs/enrichment-pt6-wlx-sev-crit.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpsev6.cs[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
ggsave(
  filename = "graphs/enrichment-pt6-wlx-sev-mod.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpsev6.sm[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
ggsave(
  filename = "graphs/enrichment-pt6-wlx-mod-crit.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpmod6.cm[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
ggsave(
  filename = "graphs/enrichment-pt6-wlx-mod-sev.jpeg",
  dpi = "print",
  height = 10,
  width = 10,
  units = "in",
  plot = plotEnrich(
    enrich.topUpmod6.sm[[1]],
    numChar = 80,
    y = "Count",
    orderBy = "Adjusted.P.value",
    xlab = NULL,
...
#Enrichment plots:
ggsave(
  filename = "graphs/enrichment-plot-pt6-critical-severe.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt6-critical-moderate.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt6-severe-critical.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt6-severe-moderate.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt6-moderate-critical.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
ggsave(
  filename = "graphs/enrichment-plot-pt6-moderate-severe.tiff",
  dpi = 300,
  width = 10,
  height = 5,
  units = "in",
...
#Plotting pathways:
fgseaRes_cs6$adjPvalue <-
  ifelse(fgseaRes_cs6$padj <= 0.05, "significant", "non-significant")
cols <- c("significant" = "red") #"non-significant" = "grey",
plot_cs <-
  ggplot(fgseaRes_cs6, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt6-critical-vs-severe-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
fgseaRes_cm6$adjPvalue <-
  ifelse(fgseaRes_cm6$padj <= 0.05, "significant", "non-significant")
plot_cm <-
  ggplot(fgseaRes_cm6, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt6-critical-vs-moderate-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
fgseaRes_sc6$adjPvalue <-
  ifelse(fgseaRes_sc6$padj <= 0.05, "significant", "non-significant")
plot_sc <-
  ggplot(fgseaRes_sc6, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt6-severe-vs-critical-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
fgseaRes_sm6$adjPvalue <-
  ifelse(fgseaRes_sm6$padj <= 0.05, "significant", "non-significant")
plot_sm <-
  ggplot(fgseaRes_sm6, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt6-severe-vs-moderate-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
fgseaRes_mc6$adjPvalue <-
  ifelse(fgseaRes_mc6$padj <= 0.05, "significant", "non-significant")
plot_mc <-
  ggplot(fgseaRes_mc6, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt6-moderatee-vs-critical-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
fgseaRes_ms6$adjPvalue <-
  ifelse(fgseaRes_ms6$padj <= 0.05, "significant", "non-significant")
plot_ms <-
  ggplot(fgseaRes_ms6, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
  geom_col() +
  scale_fill_manual(values = cols) +
  coord_flip() +
  labs(x = "Pathway", y = "Normalized Enrichment Score",
...
ggsave(
  filename = "graphs/gsea-pt6-moderatee-vs-severe-top.tiff",
  width = 10,
  height = 10,
  dpi = 300,
  units = "in",
...
ggsave(
  filename = "all-pathways-moderate.tiff",
  path = "graphs/",
  dpi = "print",
  width = 15,
  height = 10,
  plot = ggplot(allm,
    ...
    theme(plot.subtitle = element_text(
      size = 12, face = "italic", color = "black"
    )) +
    theme(
...
ggsave(
  filename = "all-pathways-critical.tiff",
  path = "graphs/",
  dpi = "print",
  width = 15,
  height = 10,
...
barplot(
  height = -log10(enriched[[1]]$Adjusted.P.value[10:1]),
  names.arg = enriched[[1]]$Term[10:1],
  horiz = TRUE,
  las = 1,
  border = FALSE,
  cex.names = 0.55
...
#Subsetting BCR data:
obj.b <-
  BCR[, (BCR$patient != "Patient 5" &
           BCR$patient != "Patient 6") & BCR$severity != "healthy"]
obj.b$sample <- droplevels(obj.b$sample)
obj.b$zeverity <- "critical"
obj.b$zeverity[obj.b$severity == "mild" |
                 obj.b$severity == "moderate"] <- "moderate"
...
avg.exp.mat.b <-
  AverageExpression(obj.b.tmp, group.by = "sample", slot = 'scale.data')
...
meta.data.B <-
  meta.data.B[, c(colnames(meta.data.B)[colnames(meta.data.B) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "zeverity")]
...
col.anno <-
  HeatmapAnnotation(
    Severity = meta.data$zeverity,
    show_annotation_name = F,
    col = list(Severity = c(
      "critical" = "red", "moderate" = "blue"
    ))
  )
column_labels <-
  c(
    "moderate272_Patient1" = "Pt1",
    "critical293_Patient1" = "Pt1",
    "moderate303_Patient2" = "Pt2",
    "critical308_Patient2" = "Pt2",
    "mild186_Patient3" = "Pt3",
    "critical213_Patient3" = "Pt3",
    "mild227_Patient4" = "Pt4",
    "critical238_Patient4" = "Pt4"
  )

#Preparing separate matrices for each cell type:
rownames(meta.data.B) <- meta.data.B$sample
meta.data.B$zeverity <-
  factor(meta.data.B$zeverity, levels = c("moderate", "critical"))
hm.b <-
  Heatmap(
    t(meta.data.B[, colnames(meta.data.B) %in% diff.genes$feature]),
    column_split = meta.data.B$zeverity,
    name = "Expression",
...
obj.t <-
  TCR[, (TCR$patient != "Patient5" &
           TCR$patient != "Patient6") & TCR$severity != "healthy"]


obj.cd4 <- obj.t[, obj.t$azimuthNames == "CD4 TCM"]
obj.cd4$sample <- droplevels(obj.cd4$sample)
obj.cd4$zeverity <- "critical"
obj.cd4$zeverity[obj.cd4$severity == "mild" |
                   obj.cd4$severity == "moderate"] <- "moderate"
...
avg.exp.mat.cd4 <-
  AverageExpression(obj.cd4.tmp, group.by = "sample", slot = 'scale.data')
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.CD4 <-
  meta.data.CD4[, c(colnames(meta.data.CD4)[colnames(meta.data.CD4) %in% rownames(obj.cd4.tmp@assays$RNA@scale.data)], "sample", "zeverity")]

rownames(meta.data.CD4) <- meta.data.CD4$sample
meta.data.CD4$zeverity <-
  factor(meta.data.CD4$zeverity, levels = c("moderate", "critical"))

hm.cd4 <-
  Heatmap(
    t(meta.data.CD4[, colnames(meta.data.CD4) %in% topPathways_all$feature]),
    column_split = meta.data.CD4$zeverity,
    column_labels = column_labels,
    row_title = "CD4 TCM",
    col = expr.cols,
...
obj.cd8$zeverity[obj.cd8$severity == "mild" |
                   obj.cd8$severity == "moderate"] <- "moderate"
...
avg.exp.mat.cd8 <-
  AverageExpression(obj.cd8.tmp, group.by = "sample", slot = 'scale.data')
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.CD8 <-
  meta.data.CD8[, c(colnames(meta.data.CD8)[colnames(meta.data.CD8) %in% rownames(obj.cd8.tmp@assays$RNA@scale.data)], "sample", "zeverity")]
...
hm.cd8 <-
  Heatmap(
    t(meta.data.CD8[, colnames(meta.data.CD8) %in% topPathways_all$feature]),
    column_split = meta.data.CD8$zeverity,
    column_labels = column_labels,
    row_title = "CD8 TEM",
    col = expr.cols,
    show_heatmap_legend = F,
...
tiff(
  "./graphs/hm-critical-moderate-b-t-cells-isg-in-deg-pt1-4.tiff",
  res = 300,
  width = 4,
  height = 8,
  units = "in"
...
obj.b <-
  BCR[, (BCR$patient == "Patient 5" |
           BCR$patient == "Patient 6") & BCR$severity != "severe"]
obj.b$sample <- droplevels(obj.b$sample)
DefaultAssay(obj.b) <- "RNA"
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.B <-
  meta.data.B[, c(colnames(meta.data.B)[colnames(meta.data.B) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "severity")]
...
col.anno <-
  HeatmapAnnotation(
    Severity = factor(meta.data.B$severity),
    show_annotation_name = F,
    col = list(Severity = c(
      "moderate" = "blue", "critical" = "red"
    ))
  )
column_labels <-
  c(
    "critical119_Patient5" = "Pt5",
    "moderate138_Patient5" = "Pt5",
    "critical120_Patient6" = "Pt6",
    "moderate124_Patient6" = "Pt6"
  )

#Preparing separate matrices for each cell type:
rownames(meta.data.B) <- meta.data.B$sample
meta.data.B$severity <-
  factor(meta.data.B$severity, levels = c("moderate", "critical"))
hm.b <-
  Heatmap(
    t(meta.data.B[, colnames(meta.data.B) %in% diff.genes$feature]),
    column_split = meta.data.B$severity,
    name = "Expression",
    column_labels = column_labels,
    row_title = "B cells",
    column_title = " ",
...
obj.t <-
  TCR[, (TCR$patient == "Patient5" |
           TCR$patient == "Patient6") & TCR$severity != "severe"]
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.CD4 <-
  meta.data.CD4[, c(colnames(meta.data.CD4)[colnames(meta.data.CD4) %in% rownames(obj.cd4.tmp@assays$RNA@scale.data)], "sample", "severity")]

rownames(meta.data.CD4) <- meta.data.CD4$sample

meta.data.CD4$severity <-
  factor(meta.data.CD4$severity, levels = c("moderate", "critical"))

hm.cd4 <-
  Heatmap(
    t(meta.data.CD4[, colnames(meta.data.CD4) %in% topPathways_all$feature]),
    column_split = meta.data.CD4$severity,
    column_labels = column_labels,
    row_title = "CD4 TCM",
    col = expr.cols,
    show_heatmap_legend = F,
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.CD8 <-
  meta.data.CD8[, c(colnames(meta.data.CD8)[colnames(meta.data.CD8) %in% rownames(obj.cd8.tmp@assays$RNA@scale.data)], "sample", "severity")]

rownames(meta.data.CD8) <- meta.data.CD8$sample
meta.data.CD8$severity <-
  factor(meta.data.CD8$severity, levels = c("moderate", "critical"))

hm.cd8 <-
  Heatmap(
    t(meta.data.CD8[, colnames(meta.data.CD8) %in% topPathways_all$feature]),
    column_split = meta.data.CD8$severity,
    column_labels = column_labels,
    row_title = "CD8 TEM",
    col = expr.cols,
    show_heatmap_legend = F,
...
tiff(
  "./graphs/hm-critical-moderate-b-t-cells-isg-in-deg-pt5-6.tiff",
  res = 300,
  width = 4,
  height = 8,
  units = "in"
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.B <-
  meta.data.B[, c(colnames(meta.data.B)[colnames(meta.data.B) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "severity", "illness")]
...
col.anno <-
  HeatmapAnnotation(
    Status = factor(meta.data.B$illness),
    Severity = factor(meta.data.B$severity),
    show_annotation_name = F,
    col = list(
      Status = c("control" = "green", "covid" = "#00FFFF"),
      Severity = c(
        "mild" = "#000080",
        "moderate" = "blue",
        "severe" = "pink",
...
column_labels <-
  c(
    "healthy1_control1" = "HC1",
    "healthy2_control2" = "HC2",
    "healthy3_control3" = "HC3",
    "moderate272_Patient1" = "Pt1_m",
    "critical293_Patient1" = "Pt1_c",
    "moderate303_Patient2" = "Pt2_m",
    "critical308_Patient2" = "Pt2_c",
    "mild186_Patient3" = "Pt3_m",
    "critical213_Patient3" = "Pt3_c",
    "mild227_Patient4" = "Pt4_m",
    "critical238_Patient4" = "Pt4_c",
    "critical119_Patient5" = "Pt5_c",
    "severe123_Patient5" = "Pt5_s",
    "moderate138_Patient5" = "Pt5_m",
    "critical120_Patient6" = "Pt6_c",
    "severe122_Patient6" = "Pt6_s",
    "moderate124_Patient6" = "Pt6_m"
  )
...
hm.b <-
  Heatmap(
    t(meta.data.B[, colnames(meta.data.B) %in% diff.genes$feature]),
    column_split = meta.data.B$illness,
    name = "Expression",
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.CD4 <-
  meta.data.CD4[, c(colnames(meta.data.CD4)[colnames(meta.data.CD4) %in% rownames(obj.cd4.tmp@assays$RNA@scale.data)], "sample", "severity", "illness")]


hm.cd4 <-
  Heatmap(
    t(meta.data.CD4[, colnames(meta.data.CD4) %in% topPathways_all$feature]),
    column_split = meta.data.CD4$illness,
    column_labels = column_labels,
    row_title = "CD4 TCM",
    col = expr.cols,
    show_heatmap_legend = F,
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.CD8 <-
  meta.data.CD8[, c(colnames(meta.data.CD8)[colnames(meta.data.CD8) %in% rownames(obj.cd8.tmp@assays$RNA@scale.data)], "sample", "severity", "illness")]


hm.cd8 <-
  Heatmap(
    t(meta.data.CD8[, colnames(meta.data.CD8) %in% topPathways_all$feature]),
    column_split = meta.data.CD8$illness,
    column_labels = column_labels,
    row_title = "CD8 TEM",
    col = expr.cols,
    show_heatmap_legend = F,
...
tiff(
  "./graphs/hm-all-b-t-cells-isg-in-deg.tiff",
  res = 300,
  width = 4,
  height = 8,
  units = "in"
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.B.int <-
  meta.data.B.int[, c(colnames(meta.data.B.int)[colnames(meta.data.B.int) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "zeverity")]
...
col.anno <-
  HeatmapAnnotation(
    Severity = meta.data.B.int$zeverity,
    show_annotation_name = F,
    col = list(Severity = c(
      "critical" = "red", "moderate" = "blue"
    ))
...
meta.data.B.int$zeverity <-
  factor(meta.data.B.int$zeverity, levels = c("moderate", "critical"))
hm.b.int <-
  Heatmap(
    t(meta.data.B.int[, colnames(meta.data.B.int) %in% diff.genes$feature]),
    column_split = meta.data.B.int$zeverity,
    name = "Expression",
    column_labels = column_labels,
    row_title = "B intermediate",
    column_title = " ",
    col = expr.cols,
    top_annotation = col.anno,
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.B.mem <-
  meta.data.B.mem[, c(colnames(meta.data.B.mem)[colnames(meta.data.B.mem) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "zeverity")]
...
hm.b.mem <-
  Heatmap(
    t(meta.data.B.mem[, colnames(meta.data.B.mem) %in% diff.genes$feature]),
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.B.nai <-
  meta.data.B.nai[, c(colnames(meta.data.B.nai)[colnames(meta.data.B.nai) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "zeverity")]
...
hm.b.nai <-
  Heatmap(
    t(meta.data.B.nai[, colnames(meta.data.B.mem) %in% diff.genes$feature]),
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.B.pla <-
  meta.data.B.pla[, c(colnames(meta.data.B.pla)[colnames(meta.data.B.pla) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "zeverity")]


rownames(meta.data.B.pla) <- meta.data.B.pla$sample
hm.plasm <-
  Heatmap(
    t(meta.data.B.pla[, colnames(meta.data.B.mem) %in% diff.genes$feature]),
    column_split = meta.data.B.pla$zeverity,
    column_labels = column_labels,
    row_title = "Plasmablasts",
    col = expr.cols,
    show_heatmap_legend = F,
    row_names_gp = gpar(fontsize = 7),
    show_row_dend = F,
...
tiff(
  "./graphs/hm-critical-moderate-b-cells-isg-in-deg-pt1-4.tiff",
  res = 300,
  width = 4,
  height = 8,
  units = "in"
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.B.int <-
  meta.data.B.int[, c(colnames(meta.data.B.int)[colnames(meta.data.B.int) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "severity")]
...
col.anno <-
  HeatmapAnnotation(
    Severity = factor(meta.data.B.int$severity),
    show_annotation_name = F,
    col = list(Severity = c(
      "critical" = "red", "moderate" = "blue"
    ))
...
#Preparing separate matrices for each cell type:
rownames(meta.data.B.int) <- meta.data.B.int$sample
meta.data.B.int$severity <-
  factor(meta.data.B.int$severity, levels = c("moderate", "critical"))
hm.b.int <-
  Heatmap(
    t(meta.data.B.int[, colnames(meta.data.B.int) %in% diff.genes$feature]),
    column_split = meta.data.B.int$severity,
    name = "Expression",
    column_labels = column_labels,
    row_title = "B intermediate",
    column_title = " ",
...
#Changing the data to "pseudo-bulk", using ISG set:
obj.b.tmp <-
  ScaleData(obj.b.mem, features = ISGs[ISGs %in% topPathways_all.mem$feature])
avg.exp.mat.b.mem <-
  AverageExpression(obj.b.tmp, group.by = "sample", slot = 'scale.data')
avg.exp.rna.b.mem <- avg.exp.mat.b.mem$RNA
...
#Adding average/bulk expression data to meta data:
meta.data.B.mem <-
  data.frame(t(avg.exp.rna.b.mem[rownames(avg.exp.rna.b.mem) %in% diff.genes, ]), thing)

#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.B.mem <-
  meta.data.B.mem[, c(colnames(meta.data.B.mem)[colnames(meta.data.B.mem) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "severity")]
...
#Adding average/bulk expression data to meta data:
meta.data.B.nai <-
  data.frame(t(avg.exp.rna.b.nai[rownames(avg.exp.rna.b.nai) %in% diff.genes, ]), thing)

#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.B.nai <-
  meta.data.B.nai[, c(colnames(meta.data.B.nai)[colnames(meta.data.B.nai) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "severity")]
...
hm.b.nai <-
  Heatmap(
    t(meta.data.B.nai[, colnames(meta.data.B.nai) %in% diff.genes$feature]),
...
#Keeping only genes that exist in the scaled data in the Seurat object:
meta.data.B.pla <-
  meta.data.B.pla[, c(colnames(meta.data.B.pla)[colnames(meta.data.B.pla) %in% rownames(obj.b.tmp@assays$RNA@scale.data)], "sample", "severity")]


rownames(meta.data.B.pla) <- meta.data.B.pla$sample
hm.plasm <-
  Heatmap(
    t(meta.data.B.pla[, colnames(meta.data.B.pla) %in% diff.genes$feature]),
    column_split = meta.data.B.pla$severity,
    column_labels = column_labels,
    row_title = "Plasmablasts",
    col = expr.cols,
    show_heatmap_legend = F,
...
tiff(
  "./graphs/hm-critical-moderate-b-cells-isg-in-deg-pt5-6.tiff",
  res = 300,
  width = 4,
  height = 8,
  units = "in"
...
for (s in c(mod, crit)) {
  if(ncol(s) == ncol(mod)) {
    k <- c("Patient 1", "Patient 2", "Patient 3", "Patient 4"); l <- c("Patient 5", "Patient 6") 
  } else {
    k <- c("Patient 1", "Patient 2", "Patient 3"); l <- c("Patient 5", "Patient 6", "Patient 4") 
  }
  ...
  for (i in k) {
    for (j in l) {
      ...
      #Plotting pathways:
      fgseaRes_d$adjPvalue <-
        ifelse(fgseaRes_d$padj <= 0.05,
               "significant",
               "non-significant")
      cols <- c("significant" = "red") #"non-significant" = "grey",
      plot_d <-
        ggplot(fgseaRes_d, aes(reorder(pathway, NES), NES, fill = adjPvalue)) +
        geom_col() +
        scale_fill_manual(values = cols) +
        coord_flip() +
        labs(
          ...
          title = paste0(
            ...
            j,
            " - ",
            ifelse(levels(factor(s$severity))[1] == "critical", "critical", "moderate")
          )
        ) +
        theme(
      ...
      write.table(
        x = fgseaRes_d %>% mutate(
          leadingEdge = vapply(leadingEdge, paste, collapse = ", ", character(1L))
        ),
        file = paste0(
          i,
          "-vs-",
