...
allm$category[allm$pathway == "HYPOXIA" | allm$pathway == "UNFOLDED PROTEIN RESPONSE"] <- "other"
allm$category[allm$pathway == "EPITHELIAL MESENCHYMAL TRANSITION"] <- "other"
...
allc$category[allc$pathway == "HYPOXIA" | allc$pathway == "UNFOLDED PROTEIN RESPONSE"] <- "other"
allc$category[allc$pathway == "EPITHELIAL MESENCHYMAL TRANSITION"] <- "other"
...
labels <- c("immune" = "Immune", "proliferation" = "Proliferation", "signaling" = "Signaling",
            "metabolism" = "Metabolism", "other" = "Other")
...
bubble <- ggarrange(immune + rremove("xlab") + rremove("ylab"), signaling + rremove("xlab") + rremove("ylab"), metabolism + rremove("xlab") + rremove("ylab"), 
                    proliferation + rremove("xlab") + rremove("ylab"), other + rremove("ylab"),
